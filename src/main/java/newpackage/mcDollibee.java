...
public class mcDollibee extends JFrame implements ActionListener {
    ...
    mcDollibee(){
        ...
        lblBurgerCount.setBounds(160, 100, 50, 30);
        add(lblBurgerCount);
        
        lblFriesCount = new JLabel("0");
        lblFriesCount.setBounds(160, 150, 50, 30);
        add(lblFriesCount);
        
        lblSodaCount = new JLabel("0");
        lblSodaCount.setBounds(160, 200, 50, 30);
        add(lblSodaCount);
        
        btnAddBurger = new JButton("+");
        btnAddBurger.setBounds(240, 100, 50, 30);
        add(btnAddBurger);
        
        btnMinusBurger = new JButton("-");
        btnMinusBurger.setBounds(310, 100, 50, 30);
        add(btnMinusBurger);
        
        btnAddFries = new JButton("+");
        btnAddFries.setBounds(240, 150, 50, 30);
        add(btnAddFries);
        ...
        btnAddSoda.setBounds(240, 200, 50, 30);
        add(btnAddSoda);
        
        btnMinusSoda = new JButton("-");
        btnMinusSoda.setBounds(310, 200, 50, 30);
        add(btnMinusSoda);
        
        cmbBurger = new JComboBox<>(sizes);
        cmbBurger.setBounds(390, 100, 100, 30);
        add(cmbBurger);
        
        cmbFries = new JComboBox<>(sizes);
        cmbFries.setBounds(390, 150, 100, 30);
        add(cmbFries);
        
        cmbSoda = new JComboBox<>(sizes);
        cmbSoda.setBounds(390, 200, 100, 30);
        add(cmbSoda);
